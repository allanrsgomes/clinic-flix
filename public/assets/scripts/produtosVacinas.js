...
Idosos:
18: Idosos
22: Todas as idades - adicionado depois
*/
const produtosVacinas =
{
    categoria: 'Vacinas',
    categoriaAgendamento: '1',
    itens: [
        {
            id: 1,
            grupo: [11, 13, 16, 17, 18, 22],
            ...
            indicacoes: "Uso adulto e pediátrico acima de 4 anos.",
            ...
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=1",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=triplice%20bacteriana",
            /* fornecedores: [ 
                { nome: 'Refortrix GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-triplice-bacteriana-(difteria-tetano-e-coqueluche)-refortrix-gsk/p-120397', idAgendamento: '34'}
            ],*/
            tagsDoenças: ['difteria', 'tétano', 'coqueluche'],
            tagsPalavras: ['Refortrix', 'GSK', 'vacina', 'vacinas'],
            idAgendamento: 34,
        },
        // {
        //     id: 2,
        ...
        //     preco: 56.81,
        //     img: "vacinas/hepatite-b.png",
        //     urlInterna: "/panvel/vacina-detalhe.do?p=2",
        //     urlInternaLoja: "#",
        //     tagsDoenças: ['meningite']
        // },
        {
            id: 3,
            grupo: [1, 22],
            ...
            preco: 56.81,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=3",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: 'https://www.panvel.com/panvel/vacina-hepatite-b-pediatrico-engerix-gsk/p-120379',
            // fornecedores: [ 
        ...
        },
        {
            ...
            // ],
            tagsDoenças: ['pneumonia', 'meningite', 'otite'],
            tagsPalavras: ['Synflorix', 'vacina', 'vacinas'],
            idAgendamento: 51
        },
        {
            id: 5,
            grupo: [2, 4, 6, 9, 16, 18, 22],
            ...
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=5",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=Pneumoc%C3%B3cica%2013",
            // fornecedores: [ 
            //     { nome: 'Prevenar Pfizer', urlInterna: 'https://www.panvel.com/panvel/vacina-pneumococica-13-conjugada-prevenar-pfizer/p-110485'}
            // ],
            tagsDoenças: ['pneumonia', 'meningite', 'otite'],
            tagsPalavras: ['Prevenar', 'Pfizer', 'vacina', 'vacinas'],
            idAgendamento: 28
        },
        {
            id: 6,
            ...
            preco: 201.86,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=6",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=Rotavirus",
            // fornecedores: [ 
            //     { nome: 'Rotateq MSD', urlInterna: 'https://www.panvel.com/panvel/vacina-rotavirus-rotateq-msd/p-120171'}, 
            // ],
            tagsDoenças: ['rotavírus'],
            tagsPalavras: ['Rotateq', 'vacina', 'vacinas'],
            idAgendamento: 31,
        },
        {
            id: 7,
            ...
            preco: 112.45,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=7",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=hepatite%20a",
            // fornecedores: [ 
            //     { nome: 'Adulto - Havrix GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-hepatite-a-adulto-havrix-gsk/p-120382'}, 
            //     { nome: 'Pediátrico - Vaqta MSD', urlInterna: 'https://www.panvel.com/panvel/vacina-hepatite-a-pediatrico-vaqta-msd/p-120169' }
            // ],
            tagsDoenças: ['Hepatite A'],
            tagsPalavras: ['Havrix', 'Vaqta', 'vacina', 'vacinas'],
            idAgendamento: 13
        },
        {
            id: 8,
            grupo: [3, 5, 8, 12, 15, 22],
            nome: "Meningite ACWY",
            ...
            preco: 313.43,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=8",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=acwy",
            // fornecedores: [ 
            ...
            // ],
            tagsDoenças: ['Meningite A', 'Meningite C', 'Meningite W', 'Meningite Y'],
            tagsPalavras: ['Nimenrix', 'Menveo', 'vacina', 'vacinas'],
            idAgendamento: 22
        },
        {
            id: 9,
            ...
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=9",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=Meningite%20b",
            // fornecedores: [ 
            //     { nome: 'Bexsero GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-meningite-b-bexsero-gsk/p-872120'}
            // ],
            tagsDoenças: ['Meningites B'],
            tagsPalavras: ['Bexsero', 'vacina', 'vacinas'],
            idAgendamento: 24
        },
        {
            id: 10,
            ...
            preco: 48.55,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=10",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=tr%C3%ADplice%20viral",
            // fornecedores: [ 
            //     { nome: 'MMR II MSD', urlInterna: 'https://www.panvel.com/panvel/vacina-triplice-viral-(sarampo-caxumba-e-rubeola)-m-m-r-ii-msd/p-120175'}, 
            //     { nome: 'Priorix GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-triplice-viral-(sarampo-caxumba-e-rubeola)-priorix-gsk/p-112820' }
            // ],
            tagsDoenças: ['Sarampo', 'Caxumba', 'Rubéola'],
            tagsPalavras: ['Priorix', 'MMR', 'vacina', 'vacinas'],
            idAgendamento: 35
        },
        {
            id: 11,
            ...
            preco: 156.52,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=11",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=varicela",
            // fornecedores: [ 
            //     { nome: 'Varicela MSD', urlInterna: 'https://www.panvel.com/panvel/vacina-varicela-msd/p-120178'}, 
            //     { nome: 'Varilix GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-varicela-varilrix-gsk/p-119962' }
            // ],
            tagsDoenças: ['Varicela', 'Catapora'],
            tagsPalavras: ['Varilix', 'vacina', 'vacinas'],
            idAgendamento: 38,
        },
        // {
        //     id: 13,
        ...
        // },
        {
            ...
            preco: 103.13,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=14",
            urlInterna: "/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=Febre%20Amarela",
            // fornecedores: [ 
            //     { nome: 'Stamaril Sanofi', urlInterna: 'https://www.panvel.com/panvel/vacina-febre-amarela-stamaril-sanofi/p-880580'}
            // ],
            tagsDoenças: ['Febre Amarela'],
            tagsPalavras: ['Stamaril', 'Sanofi', 'vacina', 'vacinas'],
            idAgendamento: 48,
        },
        {
            id: 15,
            grupo: [16, 18, 22],
            nome: "Pneumocóccica 23",
            ...
            preco: 72.26,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=15",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=Pneumoc%C3%B3ccica%2023",
            // fornecedores: [ 
            //     { nome: 'Pneumovax MSD', urlInterna: 'https://www.panvel.com/panvel/vacina-pneumococica-23-polissacaridea-pneumovax-msd/p-821580'}        
            // ],
            tagsDoenças: ['Pneumococos'],
            tagsPalavras: ['Pneumovax'],
            idAgendamento: 29,
        },
        // {
        //     id: 16,
        ...
        //     viaaplicacao: "Intramuscular.",
        //     preco: 144.30,
        //     img: "vacinas/Thumbs/Triplice_Bacteriana_GSK.png",
        //     urlInterna: "/panvel/vacina-detalhe.do?p=",
        //     urlInternaLoja: "https://www.panvel.com/panvel/vacina-triplice-bacteriana-(difteria-tetano-e-coqueluche)-refortrix-gsk/p-120397",
        //     fornecedores: [ 
        //         { nome: 'Refortrix GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-triplice-bacteriana-(difteria-tetano-e-coqueluche)-refortrix-gsk/p-120397'}
        //     ],
        //     tagsDoenças: []
        // },
        {
            ...
            preco: 177.77,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=17",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/vacina-hepatite-ab-twinrix-gsk/p-839600",
            idAgendamento: 15,
            // tagsDoenças: []
        },
        {
            ...
            preco: 498.22,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=18",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=herpes%20z%C3%B3ster",
            // fornecedores: [ 
            //     { nome: 'Zostavax MSD', urlInterna: 'https://www.panvel.com/panvel/vacina-herpes-zoster-zostavax-msd/p-821590'}
            // ],
            tagsDoenças: ['Herpes Zóster'],
            tagsPalavras: ['Cobreiro', 'Zostavax'],
            idAgendamento: 18,
        },
        // {
        //     id: 19,
        ...
        // },
        {
            id: 21,
            grupo: [],
            nome: "Gripe H1N1 Tetravaente",
            sobre: "Fluarix® Tetra é indicada para prevenção da gripe causada pelos vírus influenza dos tipos A e B contidos na vacina.",
            prevencao: "Influenza A e B.",
            posologia: "",
            reacoes: "",
            indicacoes: "Para crianças a partir de 3 ou 4 anos de idade, adolescentes e adultos, para os reforços de seus esquemas de vacinação.<br/>    Pode substituir as formulações infantis da vacina tríplice bacteriana (DTPa e suas combinações) no reforço de 4 a 5 anos de idade.<br/>    Para adolescentes e adultos, pode substituir a vacina dTpa e é a alternativa para viajantes com destinos às áreas de risco para poliomielite.<br/>    Para gestantes, pode substituir a dTpa na indisponibilidade desta vacina ou quando se trata de gestante viajante para área de risco para a poliomielite.<br/>",
            contraindicacoes: "Fluarix® Tetra não deve ser administrada a indivíduos com conhecida hipersensibilidade a qualquer um dos componentesda fórmula ou que tenham apresentado sinais de hipersensibilidade após administração prévia de Fluarix® Tetra ou devacinas influenza.",
            viaaplicacao: "Intramuscular.",
            preco: 49.00,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=21",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=tr%C3%ADplice%20bacteriana",
            // fornecedores: [ 
            //     { nome: 'Fluarix Gsk', urlInterna: 'https://www.panvel.com/panvel/vacina-gripe-h1n1-tetravalente-fluarix-gsk/p-468540'}
            // ],
            tagsDoenças: ['Herpes Zóster'],
            tagsPalavras: ['Cobreiro', 'Zostavax']
        },
        {
            ...
            grupo: [2, 4, 6, 22],
            nome: "Hexavalente",
            sobre: "Infanrix® Hexa é indicada para a imunização primária e de reforço em crianças contra difteria, tétano, pertussis (coqueluche), hepatite B, poliomielite (paralisia infantil) e Haemophilus influenzae tipo b.",
            prevencao: "Difteria, tétano, pertussis (coqueluche), hepatite B, poliomielite (paralisia infantil) e Haemophilus influenzae tipo b.",
            posologia: "",
            reacoes: "",
            indicacoes: "Uso pediátrico acima de 2 meses",
            contraindicacoes: "Infanrix® Hexa não deve ser administrada em pessoas com conhecida hipersensibilidade (alergia) a qualquer componente da vacina ou que apresentaram sinais de hipersensibilidade após administração prévia de vacinas contra difteria, tétano, pertussis, hepatite B, pólio ou Hib. As substâncias ativas e outros componentes do Infanrix hexa® estão mencionados na Composição da bula. Os sinais de uma reação alérgica podem incluir erupção cutânea com comichão, falta de ar e inchaço da face ou da língua. <br/> Infanrix® Hexa é contraindicada se a criança tiver sofrido encefalopatia (doença neurológica) de origem desconhecida, no período de até sete dias após vacinação anterior com vacina contendo pertussis. Nessa situação, a vacinação contra coqueluche deve ser descontinuada, e o ciclo de vacinação deve ser completado com as vacinas contra difteria, tétano, hepatite B, poliomielite inativada e Hib.",
            viaaplicacao: "Intramuscular.",
            preco: 49.00,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=22",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlInternaLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=hexavalente",
            // fornecedores: [
            //     { nome: 'Hexarim Sanofi', urlInterna: 'https://www.panvel.com/panvel/vacina-hexavalente-hexaxim-sanofi/p-880730' },
            //     { nome: 'Infanrix Hexa GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-hexavalente-infanrix-hexa-gsk/p-120380' }
            // ],
            tagsDoenças: ['difteria', 'Tétano', 'Coqueluche', 'Hepatite B', 'Poliomelite'],
            tagsPalavras: ['infanrix'],
            idAgendamento: 40,
        },
        {
            id: 23,
            ...
            posologia: "",
            reacoes: "",
            indicacoes: "Meninas e mulheres entre 9 a 45 anos de idade e homens de 9 a 26 anos de idade",
            contraindicacoes: "Você não deve tomar GARDASIL® se: <br/> • você (ou seu filho[a]) for alérgico(a) a qualquer um dos componentes da vacina;</br> • você (ou seu filho[a]) sofrer alguma reação alérgica após receber uma dose da vacina",
            viaaplicacao: "Intramuscular.",
            preco: 49.00,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=23",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=hpv%206,11,16,18",
            // fornecedores: [ 
            //     { nome: 'Gardasil MSD', urlInterna: 'https://www.panvel.com/panvel/vacina-hpv-6111618-gardasil-msd/p-821570'}
            // ],
            tagsDoenças: ['HPV 6', 'HPV 11', 'HPV 16', 'HPV 18'],
            tagsPalavras: ['gardasil'],
            idAgendamento: 21
        },
        {
            id: 24,
            grupo: [4, 9, 22],
            nome: "Pentavalente",
            sobre: "Infanrix® Penta é indicada para a prevenção de difteria, tétano, coqueluche, poliomielite e infecções causadas por Haemophilus influenzae tipo b.",
            prevencao: "Difteria, tétano, coqueluche, poliomielite e infecções causadas por Haemophilus influenzae tipo b.",
            posologia: "",
            reacoes: "",
            indicacoes: "Para crianças acima de 2 meses até 5 anos.<br/>",
            contraindicacoes: "Infanrix® Penta não deve ser administrada a indivíduos com conhecida hipersensibilidade a qualquer componente da fórmula. <br/> Infanrix® Penta é contraindicada para crianças que tenham apresentado quadro neurológico de causa desconhecida num período de até sete dias após o uso de vacina contendo antígeno de pertussis.",
            viaaplicacao: "Intramuscular.",
            preco: 49.00,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=24",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=Pentavalente",
            // fornecedores: [ 
            //     { nome: 'Infanrix Penta GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-pentavalente-infanrix-penta-gsk/p-120398'}
            // ],
            tagsDoenças: ['difteria', 'Tétano', 'Coqueluche', 'Poliomielite'],
            tagsPalavras: ['infanrix®'],
            idAgendamento: 26,
        },
        {
            ...
            grupo: [8, 10, 22],
            nome: "Tetra Viral",
            sobre: "Priorix® Tetra é utilizada na prevenção de sarampo, caxumba, rubéola e varicela (catapora), ou seja, estimula o organismo a produzir defesas contra os vírus que causam essas doenças e a preveni-las. A vacina destina-se à prevenção, e não ao tratamento.",
            prevencao: "Sarampo, caxumba, rubéola e varicela (catapora)",
            posologia: "",
            reacoes: "",
            indicacoes: "Indivíduos a partir de 12 meses de idade. A utilização em crianças com menos de 12 meses pode ser considerada no caso de situação epidemiológica justificada (ou seja, surto ou epidemia) em que a vacina pode ser administrada a partir de 9 meses de idade. A utilização de Priorix® Tetra deve ser baseada nas recomendações oficiais.",
            contraindicacoes: "Indivíduos com alergia conhecida a neomicina ou a qualquer outro componente da fórmula (ver o item Composição). <br/> Indivíduos que após administração anterior de vacinas contra sarampo, caxumba, rubéola e/ou varicela mostraram sinais de alergia. </br> Mulheres grávidas. A gravidez deve ser evitada por um mês após a vacinação. </br> Indivíduos com grave imunodeficiência humoral ou celular (primária adquirida) (ver também “O que devo saber antes de usar este medicamento?”). Assim como com outras vacinas, a administração de Priorix® Tetra a indivíduos com doença febril aguda grave deve ser adiada.",
            viaaplicacao: "Intramuscular.",
            preco: 49.00,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=25",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=tetra%20viral",
            // fornecedores: [ 
            //     { nome: 'Priorix Tetra GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-tetra-viral-(sarampo-caxumba-rubeola-e-varicela)-priorix-tetra-gsk/p-120400'},
            //     { nome: 'Proquad MSD', urlInterna: 'https://www.panvel.com/panvel/vacina-tetra-viral-(sarampo-caxumba-rubeola-e-varicela)-proquad-msd/p-115277'}
            // ],
            tagsDoenças: ['sarampo', 'caxumba', 'rubéola', 'varicela'],
            tagsPalavras: ['priorix'],
            idAgendamento: 50
        },
        {
            id: 26,
            grupo: [11, 22],
            nome: "Quadri Bacteriana",
            sobre: "Refortrix® IPV é utilizada na prevenção da difteria, tétano, coqueluche e poliomielite, ou seja, a vacina estimula o organismo a produzir defesas contra os agentes que causam essas doenças e, assim, a preveni-las. A vacina se destina a prevenção e não ao tratamento.",
            prevencao: "Difteria, tétano, coqueluche e poliomielite. ",
            posologia: "",
            reacoes: "",
            indicacoes: "Uso adulto e pediátrico acima de 3 anos.",
            contraindicacoes: "Não deverá ser administrada a indivíduos com alergia (hipersensibilidade) conhecida a qualquer um dos componentes da formulação ou a pessoas que anteriormente tenham demonstrado sinais de reações alérgicas (hipersensibilidade) após receber vacinas contra difteria, tétano, coqueluche ou poliomielite anteriormente. Os sinais de reação alérgica podem incluir coceira da pele, rash, falta de ar e inchaço do rosto e língua. </br> É contraindicada a pessoas que sofreram quadro neurológico de causa desconhecida dentro dos 7 dias seguintes ao recebimento de vacina que continha pertussis. Nessas circunstâncias, a vacinação contra pertussis deverá ser suspensa, dando continuidade ao curso das vacinas contra difteria, tétano e poliomielite. Refortrix® IPV não deverá ser administrada a pessoas que tenham sofrido complicações de natureza neurológica (para convulsões ou episódios hipotônicos-hiporresponsivos. ",
            viaaplicacao: "Intramuscular.",
            preco: 49.00,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=26",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=Quadri%20Bacteriana",
            // fornecedores: [ 
            //     { nome: 'Refortrix IPV GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-quadri-bacteriana-(difteria-tetano-coqueluche-+-poliomelite)-refortirx-ipv-gsk/p-120396'}
            // ],
            tagsDoenças: ['difteria', 'tétano', 'coqueluche', 'poliomielite'],
            tagsPalavras: ['refortrix'],
            idAgendamento: 30,
        },
        {
            id: 27,
            grupo: [16, 22],
            nome: "Hepatite A - Adulto",
            sobre: "Trata-se de vacina inativada, portanto, não tem como causar a doença.<br/><br/>É composta por antígeno do vírus da hepatite A, sal de alumínio amorfo, estabilizante (varia conforme o fabricante), cloreto de sódio a 0,9%. Pode conter traços de antibiótico (neomicina), fenoxietanol e formaldeído.<br/><br/>Nos serviços privados de vacinação estão disponíveis as apresentações pediátrica (para uso até 15, 17 ou 19 anos de idade, dependendo do fabricante) e de adultos.",
            prevencao: "Hepatite A.",
            posologia: "Duas doses com intervalo de seis meses.<br/>    As sociedades brasileiras de Pediatria (SBP) e de Imunizações (SBIm) recomendam a aplicação rotineira aos 12 e 18 meses de idade, ou o mais cedo possível, quando a vacinação não ocorrer nestas idades recomendadas.<br/>    O Programa Nacional de Imunizações (PNI) alterou, em 201​7, a faixa etária do esquema de dose única da vacina para crianças entre 15 meses e antes de completar ​5 anos de idade.<br/>",
            reacoes: "Em 10% dos vacinados ocorrem: irritabilidade, dor de cabeça, cansaço, dor e vermelhidão no local da aplicação.<br/>    Entre 1% e 10% dos vacinados apresentam perda de apetite, sonolência, diarreia, náusea, vômito, inchaço, mal-estar, febre baixa, endurecimento no local da aplicação.<br/>    Entre 0,1% e 1% dos vacinados relatam sintomas respiratórios, rinite, vertigem, erupções na pele, dor muscular, rigidez muscular.<br/>    Em 0,01% a 0,1% houve diminuição da sensibilidade, dormências, coceira, calafrios.<br/>",
            ...
            preco: 112.45,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=27",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
            urlLoja: "https://www.panvel.com/panvel/buscarProduto.do?termoPesquisa=hepatite%20a",
            // fornecedores: [ 
            //     { nome: 'Adulto - Havrix GSK', urlInterna: 'https://www.panvel.com/panvel/vacina-hepatite-a-adulto-havrix-gsk/p-120382'}, 
        ...
        },
        {
            ...
            preco: 56.81,
            img: "vacinas/Thumbs/default.png",
            url: "https://www.panvel.com/panvel/vacina-detalhe.do?p=28",
            urlInterna: "https://www.panvel.com/panvel/vacina-detalhe.do?p=",
...
function createVacinaButton() {
    const listVacina = produtosVacinas.itens.map((item) => {
        return `<li class="splide__slide rotavirus">
        <img src="web/rotavirus.png">
